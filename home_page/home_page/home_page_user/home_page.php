        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav nav-bin">
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Luyện tập<span class="caret"></span></a>
                        <ul class="dropdown-menu drop-menu-bin" style="border-radius:10px;margin-top:4px">
                    ...
                    <li class="admin" style="width:80px;height:30px;color:#000;background-color:#fff;text-align:center;border-radius:10px;margin-top:12px;font-weight:bold">
                        <p style="line-height:30px;">user</p> 
                    </li>
                </ul>
