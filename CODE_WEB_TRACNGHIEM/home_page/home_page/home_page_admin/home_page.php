...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav nav-bin">
                    ...
                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Quản lí<span class="caret"></span></a>
                        <ul class="dropdown-menu drop-menu-bin" style="border-radius:10px;margin-top:2px">
                            <li><a href="http://localhost:81/dethi_tracnghiem/admin/admin_manager_question/">Câu hỏi</a></li>
                            <li><a href="http://localhost:81/dethi_tracnghiem/admin/admin_manager_mark/">Lịch sử thi</a></li>
                        </ul>
                    </li>
                    <li><a href="http://localhost:81/dethi_tracnghiem/admin/admin_manager_account/page_admin/">Tài khoản</a></li>
                    
                    <li class="admin" style="width:80px;height:30px;color:#000;background-color:#fff;text-align:center;border-radius:10px;margin-top:12px;font-weight:bold;border: 2px solid orangered">
                        <p style="line-height:30px;">admin</p> 
                    </li>
                </ul>   

                

                <form class="btn-logOut" action="logout_submit.php" method="POST">
                    <ul class="nav navbar-nav navbar-right" style="font-size:22px;font-weight:bold">
                        <button type="submit" name="logout" style="margin-right: 30px;background-color:#333333;">
                            <li style="line-height: 50px;color:#ccc">
                                <span class="glyphicon glyphicon-log-in" style="padding-right: 6px;color:#ccc"></span>
                                Đăng xuất
                            </li>
                        </button>
                    </ul>
    ...
    <!-- Footer -->
    <div class="row footer" style="color: #fff;">
